...
if [[ "$SUBSCRIPTIONS" == "" ]]; then
  ...
  echo "The following subscriptions are stuck in UpgradePending: $SUBSCRIPTIONS"
  ...
  echo "Associated installplans: $INSTALL_PLANS"
  ...
  # Check status of deleted subscriptions
  oc get subscription -n ibm-common-services $SUBSCRIPTIONS -o json |\
