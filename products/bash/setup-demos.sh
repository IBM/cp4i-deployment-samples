...
function update_product_status() {
  ...
  PRODUCT_TO_ADD_TO_STATUS=$(echo $PRODUCT_OBJECT_FOR_STATUS | jq -r '.name="'$PRODUCT_NAME'" | .type="'$PRODUCT_TYPE'" | .installed="'$PRODUCT_INSTALLED'" | .readyToUse="'$PRODUCT_READY_TO_USE'" ')
