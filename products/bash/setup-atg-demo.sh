...
spec:
  sourceType: grpc
  image: ibmcom/datapower-operator-catalog@sha256:8a438f2e892378ce9dc5a2929394784aef947c1ab1ee5d1049921e746d15fd65
...
echo "TODO APIC Setup"
echo '- Create "test" org'
echo '- Create "testgen-catalog" catalog'
