...
describe('DELETE /customers/{customer_id}/orders/{order_id}', function () {
    it('respond with 401 if no authorization provided', function (done) {
        request(app)
            .delete('/customers/c3d75d675-1c61-4bce-8489-e4417ecfaafa/orders/88c51bfd-ca31-4a48-8b22-7a7cb5869174')
...
describe('DELETE /customers/{customer_id}/orders/{order_id}', function () {
    it('respond with 403 if the user is not an admin', function (done) {
        request(app)
            .delete('/customers/d5537670-bb0d-410f-adb9-cfcb04d02f06/orders/88c51bfd-ca31-4a48-8b22-7a7cb5869174')
            .set('Accept', 'application/json')
...
describe('DELETE /customers/{customer_id}/orders/{order_id}', function () {
    it('respond with 400 if the customer id is not a valid UUID', function (done) {
        request(app)
            .delete('/customers/d5537-410f-adb9-/orders/88c51bfd-ca31-4a48-8b22-7a7cb5869174')
            .set('Accept', 'application/json')
...
describe('DELETE /customers/{customer_id}/orders/{order_id}', function () {
    it('respond with 400 if the order id is not a valid UUID', function (done) {
        request(app)
            .delete('/customers/ed6875b1-1631-4916-a5f0-95fc295554ab/orders/88c58b22-')
            .set('Accept', 'application/json')
            .set('Authorization', process.env.ADMIN_AUTH)
            .expect(400)
            .end(function(error, res) {
...
describe('DELETE /customers/{customer_id}/orders/{order_id}', function () {
    it('respond with 404 if the customer does not exist', function (done) {
        request(app)
            .delete('/customers/ed6875b1-1631-4916-a5f0-95fc295554ab/orders/88c51bfd-ca31-4a48-8b22-7a7cb5869174')
            .set('Accept', 'application/json')
            .set('Authorization', process.env.ADMIN_AUTH)
            .expect(404)
            .end(function(error, res) {
...
describe('DELETE /customers/{customer_id}/orders/{order_id}', function () {
    it('respond with 404 if the order does not exist', function (done) {
        request(app)
            .delete('/customers/ed6875b1-1631-4916-a5f0-95fc295554aa/orders/88c51bfd-ca31-4a48-8b22-7a3cd5869174')
            .set('Accept', 'application/json')
            .set('Authorization', process.env.ADMIN_AUTH)
            .expect(404)
            .end(function(error, res) {
...
describe('DELETE /customers/{customer_id}/orders/{order_id}', function () {
    it('respond with 204 if the has been customer successfully deleted', function (done) {
        request(app)
            .delete('/customers/ed6875b1-1631-4916-a5f0-95fcc295554a/orders/88c51bfd-ca31-4a48-8b22-7a7cb5869174')
            .set('Accept', 'application/json')
            .set('Authorization', process.env.ADMIN_AUTH)
            .expect(204)
            .end(function(error) {
